...
-include vendor/alcatel/ot908/BoardConfigVendor.mk

TARGET_NO_BOOTLOADER := true
TARGET_BOARD_PLATFORM := unknown
TARGET_CPU_ABI := armeabi
TARGET_BOOTLOADER_BOARD_NAME := ot908

BOARD_KERNEL_CMDLINE := mem=458M console=ttyMSM2,115200n8 androidboot.hardware=qcom
BOARD_KERNEL_BASE := 0x13600100
...
TARGET_PREBUILT_KERNEL := device/alcatel/ot908/recovery_kernel
...
BOARD_DATA_DEVICE := /dev/block/mtdblock7
BOARD_DATA_FILESYSTEM := auto
BOARD_DATA_FILESYSTEM_OPTIONS := rw

BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/alcatel/ot908/recovery/recovery_ui.c
